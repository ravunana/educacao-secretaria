...
/**
 * REST controller for managing {@link com.ravunana.educacao.secretaria.domain.CategoriaAluno}.
 */
@RestController
@RequestMapping("/api")
public class CategoriaAlunoResource {
    ...
    private static final String ENTITY_NAME = "secretariaCategoriaAluno";
