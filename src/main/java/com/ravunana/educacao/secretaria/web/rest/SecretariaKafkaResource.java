...
@RestController
@RequestMapping("/api/secretaria-kafka")
public class SecretariaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SecretariaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SecretariaKafkaResource(KafkaProperties kafkaProperties) {
